package
{
   ...
   public class GAMELOADER extends Sprite
   {
      ...
      /*
       * Handler for timer progress events. Updates the loading bar and percentage text.
       * 
       * @param e TimerEvent object containing event data
       */
      ...
      /*
       * Handler for timer completion. Initiates loading of the main game SWF.
       * 
       * @param e TimerEvent object containing event data
       */
      ...
      /*
       * Handler for game SWF load completion. Removes loading screen,
       * adds the game to display list, and passes configuration data.
       * 
       * @param e Event object containing completion event data
       */
